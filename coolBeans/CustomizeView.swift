...
struct CustomizeView: View {
    ...
    var body: some View {
            ...
            Section("Basic Options"){
                Picker("Size",selection:$size){
                    ForEach(sizeOptions.indices, id: \.self){
                        index in Text(sizeOptions[index])
                    }
        ...
        .toolbar{
            Button("Save"){
                history.add(drink,size:sizeOptions[size],extraShots: extraShots,isDecaf: isDecaf,milk: milk,syrup: syrup,caffeine: caffeine,calories: calories,image: drink.image)
